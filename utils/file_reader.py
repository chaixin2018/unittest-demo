...
if __name__ == '__main__':
    ...
    y = 'E:\chaixin\\02_working\\04_automation\参考源码\参考1\WebUiTest-master\config\config.yml'
    reader = YamlReader(y)
    print(reader.data)

    e = 'E:\chaixin\\02_working\\04_automation\参考源码\参考1\WebUiTest-master\config\input.xlsx'
